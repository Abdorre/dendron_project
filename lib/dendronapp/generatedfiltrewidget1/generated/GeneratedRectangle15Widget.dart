...
import 'package:flutterapp/dendronapp/generatedfiltrewidget1/generated/GeneratedRectangle15Widget1.dart';
import 'package:flutterapp/helpers/transform/transform.dart';

/* Component Rectangle 15
...
class GeneratedRectangle15Widget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(context, '/GeneratedFiltreWidget7'),
      child: Container(
        width: 130.0,
        height: 40.0,
        child: Stack(
